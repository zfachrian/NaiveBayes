...
<div class="container" style='margin-top:90px'>
  <div class="row">
    <div class="col-12 mt-5">
      ...
      <p class="desc">Berikut ini adalah data latih yang beruda data orang yang membeli laptop.</p><br>
        ...
        <table id="dataLatih" class="display pt-3 mb-3">
          ...
          ?>
            ...
            <tr>
              ...
              <td><?php echo $hasil['hubungan']; ?></td>
              <td><?php echo $hasil['hutang'] ?></td>
              <td><?php 
              if($stt == "Iya"){
                echo "<span class='badge badge-success' style='padding:10px'>Iya</span>";
              }else{
                echo "<span class='badge badge-danger' style='padding:10px'>Tidak</span>";
              }
              ?></td>
            </tr>
